...
class BusinessSettingsController extends Controller
{
    ...
    public function updateInfo(Request $request)
    {
        ...
        if ($request->has('company_web_logo')) {
            $webLogo = ImageManager::update('company/', $webLogo['value'], 'png', $request->file('company_web_logo'));
        ...
        if ($request->has('company_mobile_logo')) {
            $mobileLogo = ImageManager::update('company/', $mobileLogo['value'], 'png', $request->file('company_mobile_logo'));
        ...
        if ($request->has('company_footer_logo')) {
            $webFooterLogo = ImageManager::update('company/', $webFooterLogo['value'], 'png', $request->file('company_footer_logo'));
        ...
        if ($request->has('company_fav_icon')) {
            $favIcon = ImageManager::update('company/', $favIcon['value'], 'png', $request->file('company_fav_icon'));
        ...
        if ($request->has('loader_gif')) {
            // dd($loader_gif);
            $loader_gif = ImageManager::update('company/', $loader_gif['value'], 'png', $request->file('loader_gif'));
