...
@section('title', \App\CPU\translate('Deal Room'))
@push('css_or_js')
...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">{{ \App\CPU\translate('Add new room')}}</li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    <form action="{{route('admin.deal.add-product',[$deal['id']])}}" method="post">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label for="name">{{ \App\CPU\translate('Add new room')}}</label>
                                    <select
                                        class="js-example-basic-multiple js-states js-example-responsive form-control capitalize"
                                        name="product_id">
                                        @foreach (\App\Model\Product::orderBy('name', 'asc')->get() as $key => $product)
                                            <option value="{{ $product->id }}">
                                                {{$product->kost['name']}}, {{ $product['type'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <th scope="col">{{ \App\CPU\translate('room_type')}}</th>
