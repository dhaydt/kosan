...
@section('title',\App\CPU\translate('Room_List'))
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="flex-start">
                            <h5>{{ \App\CPU\translate('Rooms')}} {{ \App\CPU\translate('Data')}}</h5>
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            ...
                            <div class="col-lg-4">
                                <a href="{{route('admin.product.add-new')}}" class="btn btn-primary float-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}">
                        ...
                        <div class="table-responsive">
                            <table id="datatable"
                                ...
                                @foreach($products as $k=>$p)
                                    <tr>
                                        <td class="text-center" scope="row">{{$products->firstitem()+ $k}}</td>
                                        <td><a href="{{route('admin.product.view',[$p['id']])}}">
                                                {{$p->kost->name}}
                                            </a></td>
