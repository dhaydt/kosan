...
@section('title',\App\CPU\translate('Jobs_List'))
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            ...
                            <div class="col-lg-4">
                                <a href="{{route('seller.jobs.add-new')}}" class="btn btn-primary float-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}">
                                ...
                                @foreach($products as $k=>$p)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            href="{{route('seller.jobs.edit',[$p['id']])}}">
                                            ...
                                            <form action="{{route('seller.jobs.delete',[$p['id']])}}"
...
@push('script')
    ...
    <script>
        ...
        $(document).on('change', '.status', function () {
            ...
            $.ajax({
                url: "{{route('seller.jobs.status-update')}}",
                method: 'POST',
                data: {
                    id: id,
                    status: status
